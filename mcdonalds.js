...
var header = document.querySelector('header') ,
    mainMenuList = document.querySelectorAll('.main-menu > li'),
...
for(var j=0; j<mainMenuList.length; j++){
  mainMenuList[j].addEventListener('mouseover',function(){
    ...
    header.style.borderBottom = "1px solid #ffbc0d" ;
    for(var k=0; k<mainMenuList.length; k++){
      mainMenuList[k].style.borderBottom = "none" ;
    }
    this.style.borderBottom = "4px solid #ffbc0d" ;
  });
